...
Thymer will convert specific date ranges in Google Calendar/ICS calendars to HTML invoices you can print. Take a look at sample_output.pdf for the default template.
